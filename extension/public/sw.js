const CACHE_NAME = "whytab-shell-v0.5.7";
const ICON_CACHE_NAME = "whytab-icons-v1";
const MAX_ICON_CACHE_ENTRIES = 200;
const APP_SHELL = ["./", "./privacy.html", "./app.webmanifest?v=0.5.7", "./icons/icon192.png?v=0.5.7", "./wallpapers/photo/mobile/aurora-lake.webp"];
